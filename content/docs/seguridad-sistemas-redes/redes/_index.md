...
Un sistema autónomo posee un número asignado por su RIR (Regional Internet Registers, LACNIC es el de Latinoamérica), que a su vez recibe los bloques de números de IANA (Internet Assigned Numbers Authority). Es una colección de prefijos IP bajo el control de uno o más operadores de red representando una entidad o dominio administrativo específico

> [!TIP]
> La Red de Conectividad Segura del Estado tiene el [ASN 17147](https://ipinfo.io/AS17147). Algunos ISP tienen uno o más de uno también. Esta es la información que se usa para geolocalizar las IP en algunos sistemas.
